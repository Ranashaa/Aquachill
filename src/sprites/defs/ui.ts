...
export const UI_SPRITES: Record<string, SpriteDef> = {
  ...
  'ico-heart': { palette: { h: '#ff5a7a' }, rows: ['.h.h.', 'hhhhh', 'hhhhh', '.hhh.', '..h..'] },
  'ico-fish': { palette: { o: '#ff8a2a', k: '#2b2238' }, rows: ['...ooo.', 'o.ooook', 'oooooo.', 'o..ooo.'] },
  'ico-wow': { palette: { k: '#e8453c' }, rows: ['k.k', 'k.k', 'k.k', 'k.k', '...', 'k.k'] },
  'ico-note': { palette: { k: '#3a8ad8' }, rows: ['..kk.', '..k.k', '..k..', 'kkk..', 'kkk..'] },
  'ico-camera': { palette: { k: '#2b2238', g: '#8a86a8', b: '#5fc6e8' }, rows: ['.kk....', 'kkkkkkk', 'kggbggk', 'kgbbbgk', 'kggbggk', 'kkkkkkk'] },
  'ico-star': { palette: { y: '#ffc23a' }, rows: ['..y..', '.yyy.', 'yyyyy', '.yyy.', '.y.y.'] },
  car: {
    palette: { o: '#2b2238', C: '#e8605a', c: '#b84a44', w: '#bfe8f2', t: '#3a3654', h: '#fff3a0', g: '#8a86a8' },
    rows: [
      '.......oooooooooo.......',
      '......oCwwwowwwwCo......',
      '.....oCCwwwowwwwCCo.....',
      ...
      'hCCCCCCCCCCCCCCCCCCCCCCo',
      'occcooocccccccccooocccco',
      '.ooo.t.o.......o.t.oooo.',
      '....ogo.........ogo.....',
      '.....o...........o......',
    ],
  ...
  streetlamp: {
    palette: { o: '#2b2238', g: '#5a5478', y: '#fff3a0' },
    rows: [
      '.ooooo.', 'oyyyyyo', '.ooooo.', '...o...', '...g...', '...g...', '...g...', '...g...', '...g...', '...g...',
      '...g...', '...g...', '...g...', '...g...', '...g...', '...g...', '...g...', '...g...', '...g...', '...g...',
      '...g...', '...g...', '..ggg..', '.ooooo.',
    ],
  },
